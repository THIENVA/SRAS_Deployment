                ...
                >
                    ...
                    <Box minWidth={500} maxWidth={800}>
                        <TextField
                            ...
                            value={shortName}
                            onChange={handleTextChange}
                            error={error.shortName && exShortName.toLowerCase() !== shortName.toLowerCase()}
                            helperText={
                                error.shortName && exShortName.toLowerCase() !== shortName.toLowerCase()
                                    ? messageError.shortName
                                    : ''
                            }
                        />
                    </Box>
