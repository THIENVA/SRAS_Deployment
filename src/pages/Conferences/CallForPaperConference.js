...
const CallForPaperConference = ({ searchInput, uniqueId }) => {
    ...
    useEffect(() => {
        ...
        const timeout = setTimeout(() => {
            getConferences(null, controller.signal, page * rowsPerPage, rowsPerPage, searchInput, true)
                .then((response) => {
...
export default memo(CallForPaperConference)
