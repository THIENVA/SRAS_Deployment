...
const CreatePublicationModal = ({ open, handleClose, userId, setPublications, publications, workTypes }) => {
    ...
    const [workType, setWorkType] = useState({ workTypeId: -1, workTypeName: '' })
