...
const MyConference = ({ searchInput, uniqueId }) => {
    ...
    useEffect(() => {
        ...
        const timeout = setTimeout(() => {
            getConferences(userId, controller.signal, page * rowsPerPage, rowsPerPage, searchInput)
                .then((response) => {
...
export default memo(MyConference)
