...
const NewNoteDialog = ({ open, onClose, title, handleAddingQuestion }) => {
    const [textField, setTextField] = useState('')
    const [checkboxField, setCheckboxField] = useState({
        required: true,
        visibleToAuthor: false,
        visibleToReviewer: false,
        lockedEdit: false,
    })
    const [typeSelected, setTypeSelected] = useState({ type: 'radio', typeName: TYPES.COMMENT })
