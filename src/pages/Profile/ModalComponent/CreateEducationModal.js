...
const CreateEducationModal = ({ open, handleClose, userId, setEducations, educations, academicDegrees }) => {
    ...
    const [academicDegree, setAcademicDegree] = useState({ academicDegreeId: -1, academicDegreeName: '' })
    const [datePicker, setDatePicker] = useState({ startYear: null, yearOfGraduation: null })
        ...
        >
            <Box sx={{ border: '2px solid #000' }}>
                ...
                <DialogContent dividers>
                    ...
                    <InputLayout boxStyle={{ mb: 2 }} label="Year Of Graduation">
                        <LocalizationProvider dateAdapter={AdapterDateFns} adapterLocale={enGB}>
